Attribute VB_Name = "rolloverFunctions"
        ...
        If Not IsError(cell.Value) Then
            If InStr(1, CStr(cell.Value), "2024") > 0 Then
                If checkLeftForNote(cell) Then
                    ...
                    Set tgtHeader = target.Range(cell.Address)
                    
                    If Trim(CStr(tgtHeader.Value)) <> "2025" Then
                        ProcessHeaderShift source, target, cell, tgtHeader, twinObj
                    End If
